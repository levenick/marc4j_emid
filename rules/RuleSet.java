...
public class RuleSet extends ArrayList<Rule> {
 ...
 public String getShortInputFileName() {
        return getInputFileName().substring(getInputFileName().lastIndexOf(File.separatorChar)+1);
    }
    ...
    String getCounts() {
        String returnMe = "Ruleset:" + getShortInputFileName();
