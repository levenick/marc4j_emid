...
import static jrl2016.CreateHorribleRegex.PATH;
...
//    }
    static int createRegexesFile(MyReader mr, String whereToPutIt) {
        MyWriter mw = new MyWriter(whereToPutIt);

        String[] splits = null;
        int count=0;
        mr.giveMeTheNextLine();  // throw away the header
