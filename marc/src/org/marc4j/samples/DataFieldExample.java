...
public class DataFieldExample {
    ...
    public static void main(String args[]) throws Exception {
        ...
        //InputStream input = DataFieldExample.class.getResourceAsStream("resources/VideosProvisionalSample.mrc");

        MarcReader reader = new MarcStreamReader(input);
        while (reader.hasNext()) {
            Record record = reader.next();
            //System.out.println("jrl: record=" + record.toString() + "/jrl");

            // get the first field occurence for a given tag
            DataField dataField = (DataField) record.getVariableField("245");
            System.out.println("245=>>" + dataField.toString() + '\n');
...
//            System.out.print('\n');
            ...
            spew(dataFields, "010, 100, 245, 250, 260, 300");
            spew(record.getVariableFields(), "everything!");

//            i = dataFields.iterator();
//            while (i.hasNext()) {
//                dataField = (DataField) i.next();
//                System.out.println("\tloop: " + dataField.toString());
//            }
//            System.out.print('\n');
    ...
    static void spew(List dataFields, String s) {
